...
from gen_mdakits import generate_mdakit_index

# -- Autogenerated docs ------------------------------------------------------

generate_mdakit_index()

# -- Project information -----------------------------------------------------

project = "MDAKits Registry"
author = ''
...
htmlhelp_basename = 'MDAKitRegistrydoc'
...
texinfo_documents = [
    ...
    author,
    'MDAKitRegistry',
    'A registry for packages based on MDAnalysis',
    'Miscellaneous'),
]
